---
title: "crust_of_rust_traits"
description: "title: Crust of Rust - Dispatch and Fat Pointers"
...
通常 `impl Fn()` 可能更经常使用，有一些情况下你可以使用 trait object（当然，需要object safe），因为使用 `impl Fn()` 时你会把泛型参数一直传播出去。
